...
<body>
    <div class="main">
        <div class="sidebar-wrapper dynamic-border" style="--mouse-x: 50%; --mouse-y: 50%; --radius:0px; --color: #4d4d4d">
            <div class="sidebar">
        ...
        <div class="content-wrapper dynamic-border"  style="--mouse-x: 50%; --mouse-y: 50%; --radius: 0px; --color: #4d4d4d">
            <div class="content">
