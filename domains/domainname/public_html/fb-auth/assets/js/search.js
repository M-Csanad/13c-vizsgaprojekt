    ...
    if (searchType == "category") {
      ...
      `
        <div class="image-card">
          ...
          <div class="card-actions">
              <input type="file" id="horizontal-edit" class="visually-hidden" name="horizontal-edit" accept="image/png, image/jpeg" data-orientation="horizontal" data-type="image" data-count="singular" data-image-type="category" tabindex="-1">
      ...
      `
        <div class="image-card">
          ...
          <div class="card-actions">
              <input type="file" id="vertical-edit" class="visually-hidden" name="vertical-edit" accept="image/png, image/jpeg" data-orientation="vertical" data-type="image" data-count="singular" data-image-type="category" tabindex="-1">
      ...
      `
        <div class="image-card" data-id="${thumbnail_image.id}">
      ...
      for (let image of product_images) {
        ...
        `
          <div class="image-card" data-id="${image.id}">
            ...
            <div class="card-actions">
                <input type="file" name="product-edit-${image.id}" id="product-edit-${image.id}" class="visually-hidden" accept="image/png, image/jpeg" data-orientation="any" data-type="image" data-count="singular" data-image-type="product" data-image-id="${image.id}" data-id="${item.id}" tabindex="-1">
                <label for="product-edit-${image.id}" class="action-edit" role="button" aria-label="Edit image">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill edit" viewBox="0 0 16 16">
                      <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z"/>
                    </svg>
                </label>
                <button type="button" class="action-delete" role="button" aria-label="Delete image" data-image-id="${image.id}" data-image-type="product">
