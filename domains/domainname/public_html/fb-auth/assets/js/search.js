    ...
    if (searchType == "category") {
      ...
      productImagesContainer.innerHTML += `
        <div class="add-field-light">
          <input type="file" id="product-add-image" class="visually-hidden" accept="image/jpeg" data-orientation="any" data-type="image" data-count="singular" data-id="${item.id}" data-item-type="product" tabindex="-1">
