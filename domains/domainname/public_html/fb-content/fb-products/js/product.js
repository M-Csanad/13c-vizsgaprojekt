class ProductPage {
  constructor() {
    ...
    window.addEventListener("scroll", checkBigButtonVisibility);
    window.addEventListener("resize", checkBigButtonVisibility);
  ...
  initDOM() {
    ...
    this.imageViewer = {
      ...
      navigator: {
        ...
        scrollbar: document.querySelector(
  ...
  bindEvents() {
    ...
    this.imageViewer.navigator.carousel.addEventListener("scroll", () =>
      this.handleScroll(
        this.imageViewer.navigator.scrollbar,
        this.imageViewer.navigator.carousel
      )
    );
    ...
    this.recommendations.container.addEventListener("scroll", () =>
      this.handleScroll(
        this.recommendations.scrollbar,
        this.recommendations.container
      )
    );
  ...
  generateReviewSection() {
    ...
    const rating = parseFloat(
      this.avgReviewElement.getAttribute("data-rating")
    );
    const reviewCount = parseInt(
      this.avgReviewElement.getAttribute("data-reviews")
    );
