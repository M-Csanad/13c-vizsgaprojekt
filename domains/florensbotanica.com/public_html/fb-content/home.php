 ...
 */
  ...
  <!--main stylesheet-->
  <link rel="stylesheet" href="./fb-home/css/main.css" media="print" onload="this.media='all'" />
  <link rel="stylesheet" href="./fb-home/css/main_media.css" media="all" />
  <link rel="stylesheet" href="./assets/css/footer.css" media="all" />
  <link rel="stylesheet" href="./assets/css/navbar.css" media="all" />
  <script src="./assets/js/autogenerate__footer.js" defer></script>
  <script src="./assets/js/autogenerate__navbar.js" defer></script>
  ...
  <script type="text/javascript" src="./fb-home/js/swiper.js" defer></script>
  <script type="text/javascript" src="./fb-home/js/swiperThumbs.js" defer></script>

  <!--video restart-->
  <script src="./fb-home/js/videoMouseHover.js" defer></script>
  <script src="./fb-home/js/videoContentScroll.js" defer></script>

  <!--parallax-->
  <script src="./fb-home/js/parallaxEffect.js" defer></script>
  <script src="./fb-home/js/imageParallaxGallery.js" defer></script>
  <script src="./fb-home/js/movingGradientEffect.js" defer></script>
  ...
  <main>
      ...
      <div id="headScroller_container flex-block">
        <div class="videoScene_wrapper col-12">
          ...
          <video id="welcomeVideo" preload="auto" loading="lazy" autoplay muted loop>
            ...
            <source src="./assets/media/videos/home/1920x1080_30Fps_VP9.webm" type="video/webm"
              media="(min-width: 1920px)">
            <source src="./assets/media/videos/home/1280x720_30Fps_VP9.webm" type="video/webm"
              media="(min-width: 1280px)">
            <source src="./assets/media/videos/home/640x360_30Fps_VP9.webm" type="video/webm">

            <!-- MP4 formátum (H.264 kodek) -->
            <source src="./assets/media/videos/home/1920x1080_30Fps_H264.mp4" type="video/mp4"
              media="(min-width: 1920px)">
            <source src="./assets/media/videos/home/1280x720_30Fps_H264.mp4" type="video/mp4"
              media="(min-width: 1280px)">
            <source src="./assets/media/videos/home/640x360_30Fps_H264.mp4" type="video/mp4">
        ...
        <div class="videoContent_wrapper">
          <div class="videoContent_scrollable">
            <div class="videoContent_card-content">
              <img src="./assets/media/images/logos/herbalLogo_white.png" alt="Florens Botanica Logo" />
            </div>
            <div class="videoContent_card-content">
              <p class="__t03-law1">
    ...
    <section id="__main_body">
      ...
      <div id="categorychooser">
        <?php include './fb-home/__gen_categorychooser.php'; ?>
      </div>
      ...
      <div id="brand-philosophy_container">
        ...
        ./assets/media/images/site/home/HerbsOnDesk-3840px.avif 3840w,
        ./assets/media/images/site/home/HerbsOnDesk-2560px.avif 2560w,
        ./assets/media/images/site/home/HerbsOnDesk-1920px.avif 1920w,
        ./assets/media/images/site/home/HerbsOnDesk-1024px.avif 1024w
      " sizes="(max-width: 1024px) 1024px,
        ...
        ./assets/media/images/site/home/HerbsOnDesk-3840px.webp 3840w,
        ./assets/media/images/site/home/HerbsOnDesk-2560px.webp 2560w,
        ./assets/media/images/site/home/HerbsOnDesk-1920px.webp 1920w,
        ./assets/media/images/site/home/HerbsOnDesk-1024px.webp 1024w
      " sizes="(max-width: 1024px) 1024px,
             (max-width: 1920px) 1920px,
             (max-width: 2560px) 2560px,
             3840px" />
            ...
            <div class="brandImages_imgHorizontal">
              <picture>
                <!-- AVIF formátum -->
                <source type="image/avif" srcset="
        ./assets/media/images/site/home/HerbsInHands-3840px.avif 3840w,
        ./assets/media/images/site/home/HerbsInHands-2560px.avif 2560w,
        ./assets/media/images/site/home/HerbsInHands-1920px.avif 1920w,
        ./assets/media/images/site/home/HerbsInHands-1024px.avif 1024w
      " sizes="(max-width: 1024px) 1024px,
             (max-width: 1920px) 1920px,
             (max-width: 2560px) 2560px,
             3840px" />
                <!-- WebP formátum -->
                <source type="image/webp" srcset="
        ./assets/media/images/site/home/HerbsInHands-3840px.webp 3840w,
        ./assets/media/images/site/home/HerbsInHands-2560px.webp 2560w,
        ./assets/media/images/site/home/HerbsInHands-1920px.webp 1920w,
        ./assets/media/images/site/home/HerbsInHands-1024px.webp 1024w
      " sizes="(max-width: 1024px) 1024px,
             (max-width: 1920px) 1920px,
             (max-width: 2560px) 2560px,
             3840px" />
                <!-- Alapértelmezett JPG -->
                <img src="./assets/media/images/site/home/HerbsInHands-1024px.jpg" alt="Gyógynövények hölgy kezében"
                  loading="lazy" />
              </picture>
            </div>
          </div>
      ...
      <div id="categoryGallery" class="ImgGallery_container"><?php include './fb-home/__gen_imageGallery.php'; ?></div>
